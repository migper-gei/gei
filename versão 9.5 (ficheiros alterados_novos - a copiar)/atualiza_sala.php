...
?>
   ...
   <script>
window.setTimeout(function() {
    window.location.href = '<?php echo SVRURL ?>sala?x=1&&escola=<?php echo $row['id_escola']?>';
}, 10);
</script>
...
?>     
                 ...
                 <form action = "<?php echo SVRURL ?>salas?x=<?php echo base64_encode(1)?>&&esi=<?php echo base64_encode($row['id_escola'])?>" method="post" >
