      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <div class="titlepage">
                     <h2>Nº de avarias da sala<br> <?php echo($ns);?> 
                     (<?php echo($ne);?>)
                    </h2>
                  </div>
               </div>
...
<img src="<?php echo SVRURL ?>images/informacao.svg" alt="Informação">
   ...
   <div class="d-flex flex-row-reverse bd-highlight mb-3">
            <form action="num_avarias_sala.php?x=1&&sa=<?php echo($sa);?>&&escola=<?php echo($idescola);?>" method="post">
        ...
        <table class="table table-striped" id="js-sort-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    href="avarias_sala.php?sa=<?php echo($sa);?>&&per=<?php echo $row['periodo'];?>&&al=<?php echo $row['ano_letivo'];?>&&escola=<?php echo $idescola ?> ">             
                    <h5>  
                    <?php echo $row['c'];   ?>
        ...
        <nav aria-label="Page navigation example mt-5">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a style="color:black;" class="page-link" href="num_avarias_sala.php?x=1&&sa=<?php echo($sa);?>&&escola=<?php echo($idescola);?>&&page=<?= $i; ?>"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>
