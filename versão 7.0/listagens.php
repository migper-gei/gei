...
?>     
 ...
 <form action="qta_equipamentos_sala_tiposequi.php?x=0&&escola=<?php echo $esc ?>" method="post" >



Quantidade por sala do tipo:
...
echo('<select required name="tiposequi">');
...
?>     
  &nbsp;&nbsp;&nbsp;
    ...
    <input  type=image name=sala src="images/lupa2.svg"   title="Quantidade por sala do tipo">
...
<form action="num_avarias_tipoeq.php?x=0&&escola=<?php echo $esc?>" method="post" >



Nº de avarias por tipo equipamento:
...
echo('<select required name="tipoeq">');
while($row=mysqli_fetch_array($result))
{
