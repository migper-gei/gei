...
?>
   ...
   window.setTimeout(function() {
       window.location.href = '<?php echo SVRURL ?>inserirequipx=1&&escola=<?php echo $idescola ?>';
   }, 10);
   </script>
<?php
}
...
<form name="form2" action = "<?php echo SVRURL ?>gravaequipdadosrede.php?id=<?php echo($id)?>&&escola=<?php echo $idescola ?>" method = "post">
