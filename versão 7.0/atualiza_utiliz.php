...
<?php
 ...
 $sql = "select * from utilizadores where id=".$url[0]."";
...
<form action = "<?php echo SVRURL ?>atualiza_ok_utiliz.php?id=<?php echo $row['id']; ?>" method = "post" >
                    <label>Utilizador: </label>  <br>  
                    <input class="underlineHover" size=50 type = "text" name = "nome"  readonly value="<?php echo $row['nome']; ?>"/><br /><br />
                 
                     <label>Email: </label>  <br>  
                    <input class="underlineHover" size=50 type = "text" name = "email"  readonly value="<?php echo $row['email']; ?>"/><br /><br />
                    ...
                    <?php 
                     ...
                     (1 - Administrador &nbsp; &nbsp;      2 - Utilizador   &nbsp; &nbsp;       3 - Reparador)
