      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <div class="titlepage">
                     <h2>Estatística de avarias <br> últimos 5 anos letivos
                     <br> <?php echo $ne; ?>
                    </h2>
                  </div>
               </div>
...
?>
       ...
       <div class="d-flex flex-row-reverse bd-highlight mb-3">
            <form action="estatistica_avarias.php?escola=<?php echo $idescola?>" method="post">
            ...
            <ul class="pagination justify-content-center">
                <li class="page-item <?php if($page <= 1){ echo 'disabled'; } ?>">
                    <a style="color:black;" class="page-link"
                        href="<?php if($page <= 1){ echo '#'; } else { echo "escola=$idescola&&page=" . $prev; } ?>"><<</a>
                </li>

                <?php for($i = 1; $i <= $totoalPages; $i++ ): ?>
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a style="color:black;" class="page-link" href="estatistica_avarias.php?escola=<?php echo $idescola?>&&page=<?= $i; ?>"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>

                <li class="page-item <?php if($page >= $totoalPages) { echo 'disabled'; } ?>">
                    <a style="color:black;" class="page-link"
                        href="<?php if($page >= $totoalPages){ echo '#'; } else {echo "escola=$idescola&&page=". $next; } ?>">>></a>
                </li>
