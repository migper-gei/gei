      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <div class="titlepage">
                     <h2>Equipamentos com mais avarias <br>top 10 - <?php echo $op2?> 
                    <br><?php echo $ne;?>
                    </h2>
                     ...
                     <a style="color:black;" class="underlineHover" title="Equipamentos com mais avarias - top 10 (todos os anos letivos)" 
                       href="<?php echo SVRURL ?>equipamentos_mais_avarias_top.php?op=t&&escola=<?php echo $idescola; ?>">
                       Todos os anos letivos </a>  &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;   
                       <a style="color:black;" class="underlineHover" title="Equipamentos com mais avarias - top 10 (ano letivo)" 
                       href="<?php echo SVRURL ?>equipamentos_mais_avarias_top.php?op=al&&escola=<?php echo $idescola; ?>">
...
<img src="<?php echo SVRURL ?>images/informacao.svg" alt="Informação">
   ...
   <div class="d-flex flex-row-reverse bd-highlight mb-3">
            <form action="equipamentos_mais_avarias_top.php?op=<?php echo $op?>&&escola=<?php echo $idescola ?>" method="post">
        ...
        <table class="table table-striped" id="js-sort-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    title="Ver avarias" href="num_avarias_equipamento.php?x=1&&eq=<?php echo $row['id_equi'];?>&&escola=<?php echo $idescola;?>     ">             
                    <h5>  
                    <?php echo $row['c'];   ?>
            ...
            <ul class="pagination justify-content-center">
                <li class="page-item <?php if($page <= 1){ echo 'disabled'; } ?>">
                    <a style="color:black;" class="page-link"
                        href="<?php if($page <= 1){ echo '#'; } else { echo "?op=$op&&escola=$idescola&&page=" . $prev; } ?>"><<</a>
                </li>

                <?php for($i = 1; $i <= $totoalPages; $i++ ): ?>
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a style="color:black;" class="page-link" href="equipamentos_mais_avarias_top.php?op=<?php echo $op?>&&escola=<?php echo $idescola ?>&&page=<?= $i; ?>"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>

                <li class="page-item <?php if($page >= $totoalPages) { echo 'disabled'; } ?>">
                    <a style="color:black;" class="page-link"
                        href="<?php if($page >= $totoalPages){ echo '#'; } else {echo "?op=$op&&escola=$idescola&&page=". $next; } ?>">>></a>
                </li>
