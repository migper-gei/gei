...
<img src="<?php echo SVRURL ?>images/informacao.svg" alt="Informação">
   ...
   <div class="d-flex flex-row-reverse bd-highlight mb-3">
            <form action="salas_mais_avarias_top.php?op=<?php echo $op?>&&escola=<?php echo $idescola ?>" method="post">
        ...
        <nav aria-label="Page navigation example mt-5">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a style="color:black;" class="page-link" href="salas_mais_avarias_top.php?op=<?php echo $op?>&&escola=<?php echo $idescola ?>&&page=<?= $i; ?>"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>
