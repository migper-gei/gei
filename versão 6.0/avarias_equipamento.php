      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <div class="titlepage">
                     <h2>Avarias do equipamento<br> <?php echo($noeq);?> - <?php echo($ns);?>
                     <br>
                     (<?php echo($ne);?>) </h2>
                  </div>
               </div>
...
$em=$_SESSION['email'];
  ...
  $sql = "select ar.*, s.nome from avarias_reparacoes ar, salas s 
...
?>
        ...
        <div class="d-flex flex-row-reverse bd-highlight mb-3">
            <form action="avarias_equipamento.php?eq=<?php echo $eq; ?>&&al=<?php echo $al;?>&&per=<?php echo $per;?>&&escola=<?php echo $idescola;?>" method="post">
        ...
        <nav aria-label="Page navigation example mt-5">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a style="color:black;" class="page-link" href="avarias_equipamento.php?eq=<?php echo $eq; ?>&&al=<?php echo $al;?>&&per=<?php echo $per;?>&&escola=<?php echo $idescola;?>&&page=<?= $i; ?>"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>
...
<a href="<?php echo SVRURL ?>num_avarias_equipamento.php?x=1&&eq=<?php echo $eq;?>&&escola=<?php echo $idescola ?>">
