...
<a class="underlineHover" title="Tarefas a realizar" href="<?php echo SVRURL ?>salas.php?x=0">
<h3 style="color:blue;">SALAS</h3></a>
...
&nbsp;&nbsp;&nbsp;&nbsp;
<a  class="underlineHover" title="Ficheiro exemplo" href="<?php echo SVRURL ?>importar_files/salas.csv"><h6 style="color:blue;">(Ficheiro exemplo CSV) (Caso já exista a sala, não é importada)</h6></a>
...
if ($_SESSION['tipo']==1)
{
 ...
 <a class="underlineHover" title="Tarefas a realizar" href="<?php echo SVRURL ?>tarefas.php?x=0">
<h3 style="color:blue;">TAREFAS A REALIZAR</h3></a>
