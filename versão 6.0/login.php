...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form action = "<?php echo SVRURL ?>validaus/0" method = "post">
    <!--
...
?>
    ...
    <a  class="underlineHover" href="registauser" title="Registar">Registo</a>
      |
      <a  class="underlineHover" href="<?php echo($h)?>" title="Recuperar password">Recuperar Password</a>
      |
      <a class="underlineHover" href="<?php echo($h1)?>" title="Mudar password">Mudar Password</a>
    </div>
