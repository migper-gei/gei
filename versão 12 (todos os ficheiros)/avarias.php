...
<form name="frme" id="frme" action = "" method = "post" >
   ...
   <select title="Escolha a institição" 
...
<button style="width:100%;" title="Inserir avaria" type="submit" class="btn btn-outline-primary" >Inserir</button>
...
<button style="width:100%;" type="submit" class="btn btn-outline-primary" title="Ver equipamento da sala">Minhas avarias</button>
</form >
...
<button style="width:100%;" type="submit" class="btn btn-outline-primary" title="Ver avarias/reparações da sala">Ver avarias da sala</button>
