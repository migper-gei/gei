...
define("BACKUP_DIR", 'backup-bd-gei'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", 'myphp-backup-geidb-20230210_202158.sql.gz'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
