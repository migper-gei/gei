...
<button title="Ver nº de tarefas a realizar por escola" type="submit" class="btn btn-outline-primary" > Ver nº de tarefas a realizar por escola/instituição</button>
        ...
        <table   class="table table-striped" id="js-sort-table"  >
            <thead>
                <tr class="table-success">
                    ...
                    <a class="btn btn-outline-primary"   title="Inserir tarefa" href="<?php echo SVRURL ?>inserir_tarefa.php?ti=<?php echo base64_encode ($esc) ?>">
