            ...
            <div class="row">
               ...
               <nav style="margin-bottom:10px;">
                  <ol style="display:flex;align-items:center;flex-wrap:wrap;gap:4px;list-style:none;padding:0;margin:0;font-size:.8rem;font-weight:600;color:#7b88a0;">
                     ...
                     <li style="color:#1e2a45;">Tipos de equipamento >> Importação</li>
                  </ol>
               </nav>
               <div class="titlepage">
...
.then(function() { window.location = "<?php echo SVRURL ?>importar_tiposequip.php"; });
</script>
<?php
    } else {
        ...
        else
        {
                ...
                if ($_FILES["file"]["size"] > 0) {
                    ...
                    $file1 = fopen($fileName1, "r");
                                        ...
                                        $stmt_chk = $db->prepare("SELECT id FROM tipos_equipamento WHERE nome = ? LIMIT 1");
...
<form class="needs-validation" novalidate enctype="multipart/form-data" method="post" action="<?php echo SVRURL ?>importar_tiposequip.php">
                ...
                <div class="action-section">
                    ...
                    <input class="form-control required-field" name="file" type="file" class="form-control" required accept=".csv">
