            ...
            <div class="row">
               ...
               <nav style="margin-bottom:10px;">
                  <ol style="display:flex;align-items:center;flex-wrap:wrap;gap:4px;list-style:none;padding:0;margin:0;font-size:.8rem;font-weight:600;color:#7b88a0;">
                     ...
                     <li style="color:#1e2a45;">Tipos de equipamento >> Atualizar</li>
                  </ol>
               </nav>
               <div class="titlepage">
...
$_nome_eq  = $_POST["nomeeq"] ?? '';
$_nom_old  = $_GET["nom"]    ?? '';
$stmt0 = $db->prepare("UPDATE tipos_equipamento SET nome=? WHERE id=?");
$stmt0->bind_param("si", $_nome_eq, $idtipo);
$stmt0->execute();
$stmt0->close();
$stmt2 = $db->prepare("UPDATE equipamento SET tipo=? WHERE tipo=?");
$stmt2->bind_param("ss", $_nome_eq, $_nom_old);
$stmt2->execute();
$stmt2->close();
