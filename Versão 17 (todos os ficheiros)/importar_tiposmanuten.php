            ...
            <div class="row">
               ...
               <nav style="margin-bottom:10px;">
                  <ol style="display:flex;align-items:center;flex-wrap:wrap;gap:4px;list-style:none;padding:0;margin:0;font-size:.8rem;font-weight:600;color:#7b88a0;">
                     ...
                     <li style="color:#1e2a45;">Tipos de manutenção >> Importação</li>
                  </ol>
               </nav>
               <div class="titlepage">
...
<?php
    } else 
    {
        ...
        { ?>
<script>
swal({ title: 'O ficheiro CSV não tem um delimitador reconhecido (vírgula, ponto e vírgula ou tabulação)!', icon: 'error' })
.then(function() { window.location = "<?php echo SVRURL ?>importar_tiposmanuten.php"; });
</script>
<?php
        }
        else
        {
                ...
                if ($_FILES["file"]["size"] > 0) {
                    ...
                    $file1 = fopen($fileName1, "r");
                                        ...
                                        $stmt_chk = $db->prepare("SELECT id FROM tipos_manutencao WHERE nome = ? LIMIT 1");
...
<form enctype="multipart/form-data" method="post" action="<?php echo SVRURL ?>importar_tiposmanuten.php" class="needs-validation" novalidate>
                <div class="form-group">
                <div class="action-section">
                    <label for="file">Escolha o ficheiro .CSV para importar (Caso já exista o tipo de manutenção, não é importada)</label>
                    <input required class="form-control required-field" name="file" type="file"  accept=".csv">
