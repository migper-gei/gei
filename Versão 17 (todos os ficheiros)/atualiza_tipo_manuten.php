               ...
               <nav style="margin-bottom:10px;">
                  <ol style="display:flex;align-items:center;flex-wrap:wrap;gap:4px;list-style:none;padding:0;margin:0;font-size:.8rem;font-weight:600;color:#7b88a0;">
                     ...
                     <li style="color:#1e2a45;">
                      <a href="<?php echo SVRURL ?>tiposmanuten" style="color:#4b6cb7;text-decoration:none;">Tipos de manutenção </a>
...
$sql = "select * from tipos_manutencao where id=".(int)base64_decode($url[0])."";
...
<form action="<?php echo SVRURL ?>atualiza_ok_tiposmanuten.php?tpi=<?php echo base64_encode($row['id']); ?>&nom=<?php echo htmlspecialchars($row['nome'], ENT_QUOTES, 'UTF-8'); ?>" method="post" class="needs-validation" novalidate>
<input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token); ?>">
                    <label>Tipo de manutenção:     </label>  <br>  
                   

                    <input class="form-control required-field"  style="width:100%;" type = "text" name="nomema"  
...
<a href="<?php echo SVRURL ?>tiposmanuten"  title="Voltar">
