...
if ( $x === 2 && ( empty($_POST['sala2']) || !isset($_POST['sala2']) ) ) {
    ...
    if ( empty($_POST["sala2"]) || !isset($_POST["sala2"]) ) {
        echo '<script>window.location.href = "' . SVRURL . 'lista";</script>';
        exit;
    }
    $sa = (int) $_POST["sala2"];
...
$rows10 = mysqli_fetch_row(mysqli_stmt_get_result($stmt_sa));
if (!$rows10) {
    echo '<script>window.location.href = "' . SVRURL . 'lista";</script>';
    exit;
}
...
mysqli_stmt_bind_param($stmt, 'iii', $sa, $paginationStart, $limit);
...
mysqli_stmt_bind_param($stmt_total, 'i', $sa);
            ...
            <div class="row">
               ...
               <nav style="margin-bottom:10px;">
                  <ol style="display:flex;align-items:center;flex-wrap:wrap;gap:4px;list-style:none;padding:0;margin:0;font-size:.8rem;font-weight:600;color:#7b88a0;">
                     ...
                     <li style="color:#1e2a45;">Nº de avarias da sala</li>
                  </ol>
               </nav>
...
<div class="d-flex flex-row-reverse bd-highlight mb-3">
    <form action="" method="post">
        <input type="hidden" name="sala2" value="<?php echo (int)$sa; ?>">
...
<div style="padding:30px 16px;text-align:center;color:#7b88a0;font-size:.9rem;background:#f4f6fb;border:1px solid #e3e8f4;border-radius:10px;">
    ...
    Não foram encontradas avarias para esta sala.
</div>
            ...
            <tr>
                ...
                <td data-label="Nº avarias">
                    <a class="gei-link" title="Ver avarias/reparações"
                       href="<?php echo SVRURL ?>avarias_sala.php?si=<?php echo base64_encode($sa); ?>&&p=<?php echo base64_encode($row['periodo']); ?>&&al=<?php echo base64_encode($row['ano_letivo']); ?>&&ies=<?php echo base64_encode($idescola); ?>">
...
<nav aria-label="Paginação">
    <ul class="pagination justify-content-center">
        ...
        <li class="page-item <?php if ($page <= 1) echo 'disabled'; ?>">
            <a style="color:black;" class="page-link"
               href="<?php if ($page <= 1) { echo '#'; } else {
                   echo SVRURL . 'num_avarias_sala.php?x=' . base64_encode(2)
                      . '&&si='  . base64_encode($sa)
        ...
        <li class="page-item <?php if ($page == $i) echo 'active'; ?>">
            <a style="color:black;" class="page-link"
               href="<?php echo SVRURL; ?>num_avarias_sala.php?x=<?php echo base64_encode(2); ?>&&si=<?php echo base64_encode($sa); ?>&&ies=<?php echo base64_encode($idescola); ?>&&page=<?php echo $i; ?>">
               <?php echo $i; ?>
            </a>
        </li>
        <?php endfor; ?>
