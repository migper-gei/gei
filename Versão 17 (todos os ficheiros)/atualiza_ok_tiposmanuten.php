            ...
            <div class="row">
               ...
               <nav style="margin-bottom:10px;">
                  <ol style="display:flex;align-items:center;flex-wrap:wrap;gap:4px;list-style:none;padding:0;margin:0;font-size:.8rem;font-weight:600;color:#7b88a0;">
                     ...
                     <li style="color:#1e2a45;">Tipos de manutenção >> Atualizar</li>
                  </ol>
               </nav>
               <div class="titlepage">
...
<?php
$idtipo = (int)base64_decode($_GET['tpi']);
...
$_nome_ma = $_POST["nomema"] ?? '';
$_nom_old = $_GET["nom"]    ?? '';
$stmt0 = $db->prepare("UPDATE tipos_manutencao SET nome=? WHERE id=?");
$stmt0->bind_param("si", $_nome_ma, $idtipo);
$stmt0->execute();
$stmt0->close();
$stmt2 = $db->prepare("UPDATE manutencao SET descricao=? WHERE descricao=?");
$stmt2->bind_param("ss", $_nome_ma, $_nom_old);
$stmt2->execute();
$stmt2->close();
