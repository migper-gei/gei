            ...
            <div class="row">
               ...
               <nav style="margin-bottom:10px;">
                  <ol style="display:flex;align-items:center;flex-wrap:wrap;gap:4px;list-style:none;padding:0;margin:0;font-size:.8rem;font-weight:600;color:#7b88a0;">
                     ...
                     <li style="color:#1e2a45;">Tipos de manutenção</li>
                  </ol>
               </nav>
               </div>
            </div>
...
<!-- ── ESTILOS DA TABELA — visíveis para TODOS os utilizadores ── -->
<style>
.gei-table-wrap {
...
<div class="gei-table-wrap">
    <div class="gei-table-toolbar">
        <div class="gei-table-toolbar-left">
            <form action="<?php echo SVRURL ?>tiposmanuten" method="post" style="margin:0;">
        ...
        <div class="gei-table-toolbar-right">
            <a href="<?php echo SVRURL ?>tiposmanuten_csv.php" target="_blank" class="gei-export-btn" title="Exportar CSV">
            ...
            <a href="<?php echo SVRURL ?>inserirtmanuten" class="gei-insert-btn" title="Inserir tipo manutenção">
    ...
    <table class="gei-table" id="js-sort-table">
        <thead>
            <tr>
                <!-- cabeçalho visível para TODOS os utilizadores -->
        ...
        <?php while ($row = mysqli_fetch_array($result)):
            $tp2 = $row['nome'];
            $n   = $row['id'];
            $sql2    = "SELECT count(*) FROM manutencao WHERE descricao='".mysqli_real_escape_string($db,$tp2)."'";
            $result2 = mysqli_query($db, $sql2);
            $rows2   = mysqli_fetch_row($result2);
            $conta   = (int)$rows2[0];
        ?>
        <tr>
            <td data-label="Tipo de manutenção" style="font-weight:500;">
                <?php echo htmlspecialchars($tp2, ENT_QUOTES, 'UTF-8'); ?>
            </td>
            <?php if ($_SESSION['tipo']==1): ?>
            <td data-label="Ações" style="text-align:center;white-space:nowrap;">
                <a class="gei-action-btn gei-btn-edit" title="Atualizar"
                   href="<?php echo SVRURL ?>atualtmanuten/<?php echo base64_encode($n); ?>">
                ...
                <a class="gei-action-btn gei-btn-delete" title="Eliminar"
                   onclick="a(<?php echo (int)$n; ?>,'<?php echo htmlspecialchars($tp2,ENT_QUOTES,'UTF-8'); ?>');"
                ...
                <?php else: ?>
                <span class="gei-action-btn gei-btn-locked" title="Com manutenção associada">
...
<div class="gei-pagination">
    ...
    <a class="gei-page-btn <?php if($page==$i) echo 'active'; ?>"
       href="<?php echo SVRURL ?>tiposmanuten?page=<?php echo $i; ?>"><?php echo $i; ?></a>
    <?php endfor; ?>
