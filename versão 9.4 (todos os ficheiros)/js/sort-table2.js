...
sortTable.init = function() {
    ...
    if (document.querySelectorAll) {
        Tables = document.querySelectorAll('#js-sort-table');
    } else {
    ...
    sheet.insertRule('#js-sort-table.js-sort-asc thead tr > .js-sort-active:not(.js-sort-none):after {content: "\\25b2";font-size: 0.7em;padding-left: 3px;line-height: 0.7em;}', 0);
    sheet.insertRule('#js-sort-table.js-sort-desc thead tr > .js-sort-active:not(.js-sort-none):after {content: "\\25bc";font-size: 0.7em;padding-left: 3px;line-height: 0.7em;}', 0);
};
