...
<?php
 ...
 $sql = "select * from tipos_equipamento where id=".$url[0]."";
...
<form action = "<?php echo SVRURL ?>atualiza_ok_tiposequip.php?id=<?php echo $row['id']; ?>&nom=<?php echo $row['nome']; ?>" method = "post" >
                    <label>Tipo de equipamento:     </label>  <br>  
                    <input class="underlineHover" size=50 type = "text" name="nomeeq"  
