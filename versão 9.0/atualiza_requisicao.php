...
if ( df <= outradata  )
				{
			alert(" A data final deve ser superior à data inicial em 1 dia.");
      return false;
		}
      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <div class="titlepage">
                     <h2>Atualizar requisição nº <?php echo $id; ?>
...
?>
      ...
      <form onSubmit="return verificadados();" name="req"  action="<?php echo SVRURL ?>atualokrequi/<?php echo ($id);?>" method="post">
<br>
      <img src="<?php echo SVRURL ?>images/informacao.svg" alt="Informação">
      Ver tabela em baixo com requisições já efetuadas.<br>
        A data da utilização deve ser superior em 1 dia em relação à data da requisição.
                   ...
                   <!--onSubmit="return verificadados();"
                    ...
                    <input  readonly  value="<?php echo $row1['datarequi']; ?>"            
                 ...
                 ?>
                    ...
                    style="background-color:#CEF6CE" required  
...
?>
                 ...
                 <select style="background-color:#CEF6CE" size="10" multiple required class="form-control" id="lstBox2" name="eqrequi[]">
...
?>
      ...
      <img src="<?php echo SVRURL ?>images/informacao.svg" alt="Informação">
        ...
        Será atribuído novo número à requisição.
