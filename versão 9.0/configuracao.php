...
DADOS DO AGRUPAMENTO/ESCOLA <br>(Logotipo, nome, site)</button>
...
<form action="<?php echo SVRURL ?>salas.php?x=0" method="post">
...
<button style="width:310px;" title="Equipamentos" type="submit" class="btn btn-outline-primary" > EQUIPAMENTOS</button>
...
<form action="<?php echo SVRURL ?>tarefas.php?x=0" method="post">
