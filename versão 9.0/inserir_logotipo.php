      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <div class="titlepage">
                     <h2>Configurações >> Inserir dados escola/agrupamento</h2>
                  </div>
               </div>
            </div>
...
<button title="Ver escolas" type="submit" class="btn btn-outline-primary" > Ver escolas</button>
...
<button onclick="l();"  title="Inserir requisição" type="submit" class="btn btn-outline-primary" >Remover logotipo</button>
