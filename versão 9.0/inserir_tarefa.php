...
$ne = $rows11[0];
  ?>
   ...
   <form action = "<?php echo SVRURL ?>grava_tarefa.php?id=<?php echo $idescola?>" method = "post" >
...
<form action = "<?php echo SVRURL ?>tarefas.php?x=1&&escola=<?php echo $idescola ?>" method="post" >
