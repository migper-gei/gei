...
<form action="<?php echo SVRURL ?>qta_equipamentos_sala.php?x=0&&escola=<?php echo $esc ?>" method="post" >
...
?>
 <form action="<?php echo SVRURL ?>qta_equipamentos_sala_tiposequi.php?x=0&&escola=<?php echo $esc ?>" method="post" >
...
<form action="<?php echo SVRURL ?>qta_equipamentos_total.php?x=0&&escola=<?php echo $esc ?>" method="post" >


<button style="width:310px;" title="Quantidade de equipamento (TOTAL)" type="submit" class="btn btn-outline-primary" >Quantidade de equipamento (TOTAL)</button>
...
<input  style="width:140px;" class="btn btn-outline-secondary dropdown-toggle" required  type = "date" name = "dataf" >   
 ...
 <form action="<?php echo SVRURL ?>num_avarias_equipamento.php?x=0&&escola=<?php echo $esc ?>" method="post" >
...
<form action="<?php echo SVRURL ?>num_avarias_sala.php?x=0&&escola=<?php echo $esc?>" method="post" >
...
<form action="<?php echo SVRURL ?>num_avarias_tipoeq.php?x=0&&escola=<?php echo $esc?>" method="post" >
...
<form action="<?php echo SVRURL ?>estatistica_avarias.php?escola=<?php echo $esc ?>" method="post" >
...
<form action="<?php echo SVRURL ?>equipamentos_mais_avarias_top.php?op=t&&escola=<?php echo $esc ?> " method="post" >
...
?>
 ...
 <br> <br>
<form action="<?php echo SVRURL ?>requisicoes_terminar_dia.php?x=0" method="post" >
...
<!--
 ...
 <br> 
<form name="requi" action="<?php echo SVRURL ?>requisicoes_terminar_entre_datas.php?x=0" method="post" >
