...
if (isConfirm) {
  ...
  window.location.href = '<?php echo SVRURL ?>entregar_requisicao_datas.php?idr='+n1+'&d1='+d1+'&d2='+d2;
}, 10);
...
<?php
if ( ( $_GET['x']<2 && !isset($d1) && !isset($d2))  || ( $_GET['x']>1))
{
...
?>
      ...
      <div class="d-flex flex-row-reverse bd-highlight mb-3">
            <form action="requisicoes_terminar_entre_datas.php?x=1&&d1=<?php echo($d1);?>&&d2=<?php echo($d2);?>" method="post">
...
?>
                    ...
                    title="Entregar" href="<?php echo SVRURL ?>>entregar_requisicao_datas.php?idr=<?php echo $idr;?>&d1=<?php echo $d1;?>&d2=<?php echo $d2;?>">
            ...
            <ul class="pagination justify-content-center">
                <li class="page-item <?php if($page <= 1){ echo 'disabled'; } ?>">
                    <a style="color:black;" class="page-link"
                        href="<?php if($page <= 1){ echo '#'; } else { echo "?x=1&&d1=".$d1."&&d2=".$d2."&&page=" . $prev; } ?>"><<</a>
                </li>

                <?php for($i = 1; $i <= $totoalPages; $i++ ): ?>
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a style="color:black;" class="page-link" href="requisicoes_terminar_entre_datas.php?x=1&&d1=<?php echo($d1);?>&&d2=<?php echo($d2);?>&&page=<?= $i; ?>"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>

                <li class="page-item <?php if($page >= $totoalPages) { echo 'disabled'; } ?>">
                    <a style="color:black;"  class="page-link"
                        href="<?php if($page >= $totoalPages){ echo '#'; } else {echo "?x=1&&d1=".$d1."&&d2=".$d2."&&page=". $next; } ?>">>></a>
                </li>
