...
if ( !isset($dat) || !isset($sa)  || !isset($sadat))
{
...
?>
        ...
        <div class="d-flex flex-row-reverse bd-highlight mb-3">
            <form action="manutencoes_sala_data.php?x=1&&sa=<?php echo($sa);?>&&dat=<?php echo($dat);?>&&escola=<?php echo($idescola);?>" method="post">
            ...
            <ul class="pagination justify-content-center">
                <li class="page-item <?php if($page <= 1){ echo 'disabled'; } ?>">
                    <a style="color:black;" class="page-link"
                        href="<?php if($page <= 1){ echo '#'; } else { echo "?x=1&&dat=".$dat."&&sa=".$sa."&&escola=$idescola&&page=" . $prev; } ?>"><<</a>
                </li>

                <?php for($i = 1; $i <= $totoalPages; $i++ ): ?>
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a style="color:black;" class="page-link" href="manutencoes_sala_data.php?x=1&&dat=<?php echo($dat);?>&&sa=<?php echo($sa);?>&&escola=<?php echo($idescola);?>&&page=<?= $i; ?>"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>

                <li class="page-item <?php if($page >= $totoalPages) { echo 'disabled'; } ?>">
                    <a style="color:black;" class="page-link"
                        href="<?php if($page >= $totoalPages){ echo '#'; } else {echo "?x=1&&dat=".$dat."&&sa=".$sa."&&escola=$idescola&&page=". $next; } ?>">>></a>
                </li>
