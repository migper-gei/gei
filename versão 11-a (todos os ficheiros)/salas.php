...
//echo $x;
     ...
     if ( $x>1 || $x<0 || !isset($x) || empty($x) || !is_numeric($x)  )  
{
?>
...
<button title="Eliminar todas as salas sem equipamento" type="submit" class="btn btn-outline-primary" >
X
</button>
<!--    
        ...
        <table   class="table table-striped" id="js-sort-table"  >
            <thead>
                <tr class="table-success" >
                    ...
                    <th  scope="col">Equipamento requisitável?</th>
                    ...
                    <a class="btn btn-outline-primary"  title="Inserir sala" href="<?php echo SVRURL ?>inserirsala?ie=<?php echo base64_encode($esc) ?>">
