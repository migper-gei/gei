      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <div class="titlepage">
                     <h2>Nº de avarias da sala<br> <?php echo($sa);?> </h2>
                  </div>
               </div>
            </div>
...
$sql = "select ano_letivo,periodo, count(*) as c FROM avaria_reparacao where sala='".$sa."'
...
<img src="<?php echo SVRURL ?>images/informacao.svg" alt="Informação">
   ...
   <div class="d-flex flex-row-reverse bd-highlight mb-3">
            <form action="num_avarias_sala.php?x=1&&sa=<?php echo($sa);?>" method="post">
        ...
        <table class="table table-striped" id="js-sort-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <a style="color:black;" class="underlineHover" title="Ver avarias" href="avarias_sala.php?sa=<?php echo($sa);?>&&per=<?php echo $row['periodo'];?>&&al=<?php echo $row['ano_letivo'];?>   ">             
                    <h5>  
                    <?php echo $row['c'];   ?>
        ...
        <nav aria-label="Page navigation example mt-5">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a style="color:black;" class="page-link" href="num_avarias_sala.php?x=1&&sa=<?php echo($sa);?>&&page=<?= $i; ?>"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>
