...
?>
      ...
      <div  class="about">
         <div class="container">
           ...
           $sql1 = "select count(*) from avaria_reparacao where datareparacao is null and ano_letivo='".$rows0[0]."'";
           $result1 = mysqli_query($db,$sql1); 
...
if ($op=='t')
{
 ...
 $sql = "select * from avaria_reparacao where datareparacao is null 
...
$sql2 = "select * from avaria_reparacao where datareparacao is null 
 ...
 <select name="records-limit"  onchange="this.form.submit()" class="custom-select">
    ...
    <!-- 
                ...
                -->
                    ...
                    <input title="Reparar" type = "submit" value = " Reparar "/>   -->
