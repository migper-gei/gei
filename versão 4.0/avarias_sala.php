      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <div class="titlepage">
                     <h2>Avarias da sala<br> <?php echo($sa);?> </h2>
                  </div>
               </div>
            </div>
...
$sql = "select * from avaria_reparacao where sala='$sa' and ano_letivo='$al' and periodo=$per
 order by dataavaria desc LIMIT $paginationStart, $limit";
$result = mysqli_query($db,$sql);


// Get total records
 $sql1 = "select count(*) from avaria_reparacao where sala='$sa' and ano_letivo='$al' and periodo=$per";
...
?>
        ...
        <div class="d-flex flex-row-reverse bd-highlight mb-3">
            <form action="avarias_sala.php?sa=<?php echo $sa;?>&&al=<?php echo $al;?>&&per=<?php echo $per;?>" method="post">
        ...
        <nav aria-label="Page navigation example mt-5">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a style="color:black;" class="page-link" href="avarias_sala.php?page=<?= $i; ?>"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>
...
<a href="<?php echo SVRURL ?>num_avarias_sala.php?x=1&sa=<?php echo $sa ?>">
