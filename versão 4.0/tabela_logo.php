<table width="100%">
  <tbody >
   ...
   <!--<td><a href="<?php echo SVRURL ?>validauser.php?z=2" title="Início" >
      -->
      <td width="50%" style="text-align:center"><a href="<?php echo SVRURL ?>validaus/2" title="Início"  >
     ...
     <?php
      ...
      <img title="Logotipo" src="<?php echo SVRURL ?>images/logo.png" alt="" width="50%" height="50%" /></a>
...
?> 
<p style="color:white;font-size: 7px;">(Logo e nome da escola não definidos.)</p>
...
<?php
   ...
   echo('<br><br>');
   ?>
   <a  target="_blank" href="<?php echo($row2['site']);?>">
