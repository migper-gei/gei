      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <div class="titlepage">
                     <h2>Quantidade de equipamento total  </h2>
                  </div>
               </div>
            </div>
...
$sql = "select tipo,count(*) as qta from equipamento group by tipo order by tipo asc LIMIT $paginationStart, $limit";
        ...
        <nav aria-label="Page navigation example mt-5">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a style="color:black;" class="page-link" href="qta_equipamentos_total.php"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>
...
WHERE  a.datareparacao is null and a.nomeequi=e.nomeequi group by e.tipo order by tipo asc"; 
