...
if ($op=='t')
{
$sql = "select sala,ano_letivo, count(*) as c FROM avaria_reparacao
GROUP by sala order by c desc
        ...
        <table class="table table-striped" id="js-sort-table">
            ...
            <tbody>
                ...
                while($row=mysqli_fetch_array($result)) { 
                    ...
                    ?>
                <tr>
                    <td width="20%"  scope="row"><?php echo $row['sala']; 
                    ...
                    title="Ver avarias" href="num_avarias_sala.php?x=1&&sa=<?php echo $row['sala'];?>   ">             
                    <h5>  
                    <?php echo $row['c'];   ?>
