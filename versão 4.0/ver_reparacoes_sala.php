      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <div class="titlepage">
                     <h2>REPARAÇÕES <br> SALA <?php echo($sa);?> entre <?php echo($di);?> e <?php echo($df);?> </h2>
                  </div>
               </div>
            </div>
...
$sql = "select * from avaria_reparacao where sala='$sa' order by datareparacao desc LIMIT $paginationStart, $limit";
$result = mysqli_query($db,$sql);


// Get total records

$sql3 = "select count(*) from avaria_reparacao where sala=$sa";
        ...
        <nav aria-label="Page navigation example mt-5">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    <a style="color:black;" class="page-link" href="reparacoes_efetuar_sala.php?x=1&&sa=<?php echo($sa);?>&&page=<?= $i; ?>"> <?= $i; ?> </a>
                </li>
                <?php endfor; ?>
...
<a href="<?php echo SVRURL ?>num_avarias_entredatas.php?x=1&di=<?php echo $di ?>&df=<?php echo $df ?>">
