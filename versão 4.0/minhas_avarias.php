...
if ($op=='t')
{
$sql = "select * from avaria_reparacao where autoravaria='$em' order by dataavaria desc LIMIT $paginationStart, $limit";
$result = mysqli_query($db,$sql);


// Get total records
 $sql1 = "select count(*) from avaria_reparacao where autoravaria='$em'";
...
$sql = "select * from avaria_reparacao where autoravaria='$em' and ano_letivo='".$rows0[0]."' order by dataavaria desc LIMIT $paginationStart, $limit";
$result = mysqli_query($db,$sql);


// Get total records
 $sql1 = "select count(*) from avaria_reparacao where autoravaria='$em' and ano_letivo='".$rows0[0]."' ";
$result1 = mysqli_query($db,$sql1); 
$rows =mysqli_fetch_row($result1);
