      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <div class="titlepage">
                     <h2>Reparações a efetuar <br> sala <?php echo $sa ?> - <?php echo $op2?> <br>
                    <h4>
                     <a style="color:black;" class="underlineHover" title="Reparações a efetuar (todas)" 
                       href="<?php echo SVRURL ?>reparacoes_efetuar_sala.php?x=1&&op=t&&sa=<?php echo($sa);?>">
                       Todas </a>  &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;   
                       <a style="color:black;" class="underlineHover" title="Reparações a efetuar (ano letivo)" 
                       href="<?php echo SVRURL ?>reparacoes_efetuar_sala.php?x=1&&op=al&&sa=<?php echo($sa);?>">
...
if ($op=='t')
{
  ...
  $sql = "select * from avaria_reparacao where datareparacao is null and sala='".$sa."' order by dataavaria desc LIMIT $paginationStart, $limit";
  ...
  // Get total records
   ...
   $sql1 = "select count(*) from avaria_reparacao where datareparacao is null and sala='".$sa."'";
...
if ($op=='al')
{
  ...
  $sql = "select * from avaria_reparacao where datareparacao is null and sala='".$sa."' 
  ...
  // Get total records
   ...
   and ano_letivo='".$rows3[0]."'  and sala='".$sa."'";
...
if(dre<dav)
{
    ...
    <div class="d-flex flex-row-reverse bd-highlight mb-3">
        <form action="<?php echo SVRURL ?>reparacoes_efetuar_sala.php?op=<?php echo $op?>&&x=1&&sa=<?php echo($sa);?>" method="post"  name="form1">
 ...
 <select name="records-limit"  onchange="this.form.submit()" class="custom-select">
        ...
        <table class="table table-striped">
            ...
            <form  name="reparacao" action="<?php echo SVRURL ?>repara_avaria.php?id=<?php echo ($row['id']);?>&&em=<?php echo ($em) ?>" method="post" 
            onSubmit="return enviardados2();">
                    ...
                    <label>Data: </label>  
                     ...
                     <input   required id="drep"   size="10" type = "date" name = "datarep" >
                    ...
                    <input required  size="35" type = "text" name = "repar_por" style="background-color:white; text-align:left">  
            ...
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item <?php if($page <= 1){ echo 'disabled'; } ?>">
                    ...
                    <a class="page-link"
                        ...
                        href="<?php if($page <= 1){ echo '#'; } else { echo "?x=1&&sa=".$sa."&&op=$op&&page=" . $prev; } ?>"><<</a>
                ...
                <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                    ...
                    <a class="page-link" href="reparafazsala?x=1&&sa=<?php echo($sa);?>&&op=$op&&page=<?= $i; ?>"> <?= $i; ?> </a>
                ...
                <li class="page-item <?php if($page >= $totoalPages) { echo 'disabled'; } ?>">
                    ...
                    <a class="page-link"
                        ...
                        href="<?php if($page >= $totoalPages){ echo '#'; } else {echo "?x=1&&sa=".$sa."&&op=$op&&page=". $next; } ?>">>></a>
