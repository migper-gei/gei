...
?>
      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <a href="#" class="btn btn-secondary disabled">Listagens >> Quantidade de equipamento (ratos) por sala</a>
               <div class="titlepage">
                     <h2>
                    <?php echo $ne ?>
                    </h2>
...
$sql = "select s.nome,ratointerface,count(ratointerface) as qta
from equipamento e, salas s
where e.id_sala=s.id and s.id_escola=$idescola
group by s.nome,ratointerface
having qta>0
order by s.nome,ratointerface asc LIMIT $paginationStart, $limit";
...
<?php
$sql0 = "
select distinct(s.id),nome,count(ratointerface) as qta
from equipamento e, salas s
where e.id_sala=s.id and s.id_escola=$idescola
group by s.nome
having qta>0
        ...
        <table class="table table-sm" id="js-sort-table">
            <thead>
                <tr class="table-primary">
                    ...
                    <th scope="col">Ratos - Interface</th>
...
$sql01 = "
select s.nome,ratointerface,count(ratointerface) as qta
from equipamento e, salas s
where e.id_sala=s.id and s.id_escola=$idescola and s.id=$idsa
group by s.nome,ratointerface
having qta>0
order by s.nome,ratointerface asc
";
$result01 = mysqli_query($db,$sql01);
              ...
              //  $c=0;
                ...
                <td   width="45%"  scope="row"> </td>
                    ...
                    <td width="40%"  scope="row"><?php echo $row['ratointerface']; 
