...
?>
      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <a href="#" class="btn btn-secondary disabled">Listagens >> Quantidade de equipamento total por sala</a>
               <div class="titlepage">
                     <h2>
                    <?php echo $ne ?>
                    </h2>
...
where e.id_sala=s.id and s.id_escola=$idescola 
or s.id=oe.id_sala
or oe.id_sala is null or s.id is null
order by s.nome asc";
*/

$sql0 = "select distinct(s.id), s.nome
from salas s
left join outro_equipamento on s.id=outro_equipamento.id_sala
and s.id_escola=1 
order by s.nome asc";
