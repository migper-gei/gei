...
{
document.getElementById('nif_err').innerHTML = '<br>'+'Código inválido.';
zip_name.focus();
...
{
   //zip_name.focus();
document.getElementById('nif_err').innerHTML = '<br>'+'Código válido.';
document.getElementById('nif_err').style.color = "#00AF33";
}
}
</script>
  ...
  <div id="formContent">
    ...
    placeholder="Nome da escola/instituição">
      ...
      <input type = "text" maxlength="9" size="9"
       ...
       id="nif" onBlur="nif_validation();" /><span id="nif_err"></span>
    ...
    <input required   oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" 
     ...
     <input required 
    type = "text" name = "nomebd" class="fadeIn second" 
    placeholder="Nome da base de dados">

    <input required 
    type = "text" name = "serverbd" class="fadeIn second" 
    placeholder="Servidor da base de dados:porta">
     <br>
