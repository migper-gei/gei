...
?>
      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <a href="#" class="btn btn-secondary disabled">Equipamentos >> Ver equipamentos da sala</a>
               <div class="titlepage">
                     <h2> 
...
<button title="Resumo do equipamento" type="submit" class="btn btn-secondary-action" >
<i class="fa-solid fa-list-ul"></i>
Resumo do equipamento</button>
    </form>
...
<button title="Eliminar todos os equipamentos informáticos da sala" type="submit" 
...
<button title="Eliminar todos os outros equipamentos da sala" type="submit" class="btn btn-danger" >
<i class="fa-solid fa-trash-can-arrow-up"></i>
