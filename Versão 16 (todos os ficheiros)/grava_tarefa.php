...
.then(function() {
window.location = "<?php echo SVRURL ?>tarefas.php?x=<?php echo base64_encode(1) ?>&&esi=<?php echo base64_encode($idescola) ?>&&x=<?php echo base64_encode(1) ?>&&z=<?php echo base64_encode(1) ?>";
});
