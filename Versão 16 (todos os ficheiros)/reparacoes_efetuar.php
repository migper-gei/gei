 ...
 <select name="records-limit"  onchange="this.form.submit()" class="custom-select">
            ...
            <tbody>
                ...
                <?php  while($row=mysqli_fetch_array($result)) { 
                   ...
                   // echo ($rows2[0]); 
                    ...
                    ?>
                <tr>
                    <th width="35%"  scope="row"><?php echo $row['nome_escola']; echo('<br>'.'/'.'<br>');
                   ...
                   ?>
                    ...
                    <form onSubmit="return enviardados2();" name="reparacao" action="repara_avaria.php?ia=<?php echo base64_encode($row['id']);?>&&em=<?php echo ($em) ?>" method="post"
                   >
    ...
    <!-- 
                ...
                &nbsp;     &nbsp;     
                 ...
                 <a href="enviar_email_reparador.php?ia=<?php echo base64_encode($row['id']);?>&&sa=<?php echo base64_encode($row['nome']);?>&&em=<?php echo base64_encode($em)?>">
