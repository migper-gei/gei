  ...
  ?>
      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <a href="#" class="btn btn-secondary disabled">Configurações >> Utilizadores</a>
               <div class="titlepage">
...
<div style="text-align: right;" class="welcome-section">
...
<a href="<?php echo SVRURL ?>userspdf" target="_blank">
                    <button title="Exportar para PDF" type="submit" class="btn btn-outline-secondary">
        ...
        <table class="table table-striped" id="js-sort-table" >
            ...
            <?php } ?>
              ...
              <?php
                    ...
                    <a class="btn btn-primary"  title="Inserir utilizador" href="<?php echo SVRURL ?>inserirutil">
