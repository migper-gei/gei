...
$connect = new PDO("mysql:host=$serverbd;dbname=$nobd;charset=utf8","root","fm1003+-FM"
...
//$connect->exec('set names utf8 COLLATE collateName');

//$connect->exec('set names utf8 COLLATE utf8mb4_unicode_ci');
...
function fetch_user_chat_history($from_user_id, $to_user_id, $connect)
{
	...
	foreach($result as $row)
	{
		...
		if($row["from_user_id"] == $from_user_id)
		{
			if($row["status"] == '2')
			{
				$chat_message = '<em>A mensagem foi apagada</em>';
