...
$idescola=base64_decode ($_GET["rei"]);
...
Complete todos os campos obrigatórios (indicados com fundo azul claro)
      ...
      action="<?php echo SVRURL ?>grava_requisicao.php?rei=<?php echo base64_encode($idescola)?>&&dr=<?php echo base64_encode($dr) ;?>" method="post" class="needs-validation" novalidate>
...
<div class="col-md-6 mb-3">
                    ...
                    <input   style="width:100%"    readonly  class="form-select" value="<?php echo date("Y-m-d"); ?>"            
...
<select class="form-control required-field" required  name="sala"  >
...
<br>
         ...
         <div class="subject-info-box-2">
            ...
            <label>Equipamentos a requisitar: 
                 ...
                 <select class="form-control required-field" size="10" multiple   id="lstBox2" name="eqrequi[]" required>
