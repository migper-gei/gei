  ...
  ?>
      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <a href="#" class="btn btn-secondary disabled">Configurações >> Equipamentos >> Importação</a>
               <div class="titlepage">
...
<div class="action-section">
                    ...
                    <input class="form-control required-field" required name="file" type="file" class="form-control">
