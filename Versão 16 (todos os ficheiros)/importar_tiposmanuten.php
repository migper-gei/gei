  ...
  ?>
      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <a href="#" class="btn btn-secondary disabled">Configurações >> Tipos de manutenção >> Importação</a>
               <div class="titlepage">
...
<form enctype="multipart/form-data" method="post" action="<?php echo SVRURL ?>importar_tiposmanuten.php" class="needs-validation" novalidate>
                ...
                <div class="action-section">
                    ...
                    <input required class="form-control required-field" name="file" type="file" >
    </div>
                </div>
                <div class="form-group">
                    <?php echo $message; ?>
