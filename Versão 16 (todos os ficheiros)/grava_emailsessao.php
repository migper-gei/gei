...
$sql = "insert into settings (email_user,pass,email_smtp,email_smtpport,nome_app,sessao_timeout,tempoduracaopass) 
values ('".$_POST["email"]."',AES_ENCRYPT('$pa', 'secret'),'".$_POST["smtp"]."',".$_POST["smtpport"].",'".$_POST["nome"]."',".$_POST["sessao"].",".$_POST["tempodurapass"].")";
$result = mysqli_query($db,$sql);
