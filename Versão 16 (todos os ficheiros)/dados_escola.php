        ...
        <table   class="table table-striped" id="js-sort-table"  >
            <thead>
                <tr class="table-primary">
                    ...
                    <th  width="80%" scope="col">Nome da instituição</th>
               ...
               $i=0;
                ...
                <tr>
                    ...
                    <td width="80%"  scope="row">
                        ...
                        <?php echo $row['morada']; ?>
                        <br>
                        <?php echo $row['codigopostal']; echo (' '); echo $row['localidade'];?>
                        <br>
                 ...
                 <td width="5%" >
                    <a title="Atualizar" href="<?php echo SVRURL ?>atualizaesc/<?php echo base64_encode ($row['id'])?>">
                    ...
                    <a onclick="a(<?php echo $id;?>,'<?php echo $no;?>');" title="Eliminar" href="<?php echo SVRURL ?>eliminaesc">
