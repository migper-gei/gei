...
?>
      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               <a href="#" class="btn btn-secondary disabled">Listagens >> Quantidade por tipo de equipamento</a>
               <div class="titlepage">
        ...
        <table class="table table-striped" id="js-sort-table">
            <thead>
                <tr class="table-primary">
                    ...
                    <th  scope="col">Equipamento - Marca/modelo</th>
            ...
            <tbody>
              ...
              //echo $sid;
                ...
                <tr>
                    ...
                    <?php 
                    $sql5 = " 
                    SELECT e.nomeequi,e.marca_modelo
                    ...
                    while($row5=mysqli_fetch_array($result5)) { 
                      ...
                      echo $row5['nomeequi'];   echo (' - ');                 
                      echo $row5['marca_modelo'];
                      echo ('<br>');
                    }
