...
<form  onSubmit="return enviardados2();" name="reparacao" id="reparacao" action="<?php echo SVRURL ?>repara_avaria.php?ia=<?php echo base64_encode($row['id']);?>" method="post">
                ...
                ?>
                   ...
                   <!-- <img src="images/envelope.svg" title="Enviar email ao autor da avaria."> -->
