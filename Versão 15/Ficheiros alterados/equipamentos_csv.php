...
'Processador','Memória','disco','Placa_gráfica','Placa_som','Monitor','Teclado','Teclado interface',
'Rato','Rato interface', 'Colunas','CD/DVD','Dominio','IP', 'Máscara_rede','Gateway','DNS_principal',
...
eq.monitor,eq.teclado,eq.tecladointerface,eq.rato,eq.ratointerface, eq.colunas,eq.cd_dvd,
