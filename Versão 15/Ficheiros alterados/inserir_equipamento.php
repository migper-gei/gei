...
&nbsp;&nbsp;&nbsp;
              <a style="color:blue;" class="underlineHover" href="<?php echo SVRURL ?>sala?x=<?php echo base64_encode(1) ?>&&esi=<?php echo base64_encode($idescola) ?>" title="Inserir novo tipo de equipamento">  
             Salas
             </a>
<?php
}
...
<br>  <br>
                     ...
                     <input  style="width:100% "  type = "text" value="<?php echo $row3['numserie']?>" name = "nserie" placeholder="Nº de série">  
                     <br>   <br> 
                     <label>Marca/Modelo:</label>  <br>
                     <input   style="width:100% "  type = "text" name = "marcamod" value="<?php echo $row3['marca_modelo']?>" placeholder="Marca/Modelo"> 
