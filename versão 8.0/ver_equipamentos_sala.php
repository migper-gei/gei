...
<div style="  text-align: center;">              
      <a  class="underlineHover" href="<?php echo SVRURL ?>qta_equipamentos_sala.php?x=1&&escola=<?php echo $idescola?>&&sa=<?php echo $said?>" title="Resumo do equipamento" style="color:blue;font-size:16px;">Resumo do equipamento</a>
</div>
            ...
            <tbody>
                ...
                <tr>
                   ...
                   <?php
                    ...
                    {
                      ?>
                     <a   title="Ver avaria" href="<?php echo SVRURL ?>reparacoes_efetuar_equip.php?eq=<?php echo $row['id'];?>&&said=<?php echo $said;?>&&escola=<?php echo $idescola ?>">
